...
class Movies {
  ...
  @override
  String toString() {
    return 'Movies(averageRating: $averageRating, backdropPath: $backdropPath, comments: $comments, description: $description, id: $id, iso31661: $iso31661, iso6391: $iso6391, name: $name, objectIds: $objectIds, page: $page, posterPath: $posterPath, public: $public, listMovies: $listMovies, revenue: $revenue, runtime: $runtime, sortBy: $sortBy, totalPages: $totalPages, totalResults: $totalResults)';
  }
